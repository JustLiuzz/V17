...
Fernazer.sendMessage(anu.id, {
                    document: fs.readFileSync('./temp/doc.pdf'), 
                    thumbnailUrl: ppuser,
                    mimetype: 'application/pdf',
                    fileLength: 99999,
                    pageCount: '100',
                    fileName: `FLIX BOT AI`,
                    caption: wel,
                    contextInfo: {
                        externalAdReply: {
...
let wel = `Waduh @${num.split("@")[0]},\nTelah Di Panggil Tuhan Dan Meninggalkan ${metadata.subject}`
Fernazer.sendMessage(anu.id, {
                    document: fs.readFileSync('./temp/doc.pdf'), 
                    thumbnailUrl: ppuser,
                    mimetype: 'application/pdf',
...
setInterval(async () => {
    ...
    return await Fernazer.sendMessage('6282245186794@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'cadangan.js' }, { quoted: q })
  }, 60 * 60 * 1000)
